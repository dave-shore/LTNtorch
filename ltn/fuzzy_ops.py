...
class AggregFocal(AggregationOperator):
    ...
    def __call__(self, xs, weights = None, dim=None, keepdim=False):
        ...
        neg_bce_loss = torch.log((1 - xs) / xs)  # Compute logit (> 0 for x < 0.5)
        focal_loss = self.alpha * (1 - xs) ** self.gamma * neg_bce_loss  # Apply focal adjustment
...
>>>>>>> f5ab916bf9cec61e943e5f3e2acb96a7f34d7932
